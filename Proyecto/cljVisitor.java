...
@Override
public String visitDeclaracionTem(ClojureParser.DeclaracionTemContext ctx) {
        return "";
}
...
@Override
public String visitOtraExpresion(ClojureParser.OtraExpresionContext ctx) {
        return "";
}
...
@Override public String visitLlave(ClojureParser.LlaveContext ctx) {
        return "";
}

@Override public String visitOperador(ClojureParser.OperadorContext ctx) {
        return "";
}
